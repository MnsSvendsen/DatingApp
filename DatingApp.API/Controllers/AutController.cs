...
namespace DatingApp.API.Controllers
{
    ...
    public class AutController : ControllerBase
    {
        ...
        public AutController(IAuthRepository repository, IConfiguration configuration)
        {
        ...
        [HttpPost("register")]
        public async Task<IActionResult> Resgister(UserForRegisterDto userForRegisterDto)
        {
